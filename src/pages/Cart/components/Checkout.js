                ...
                <div className="relative p-4 w-full max-w-md h-full md:h-auto overflow-y-auto">
                    ...
                    <div className="py-6 px-6 lg:px-8">
                        ...
                        <form className="space-y-6" >
                            <div>
                                <label htmlFor="name" className="block text-left mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Name:</label>
                            ...
                            <div>
                                <label htmlFor="email" className="block text-left mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Email:</label>
                            ...
                            <div>
                                <label htmlFor="card" className="block mb-2 text-left text-sm font-medium text-gray-900 dark:text-gray-300">Card Number:</label>
                            ...
                            <div className="text-left">
                                ...
                                <input type="number" name="month" id="month" className="inline-block w-20 text-left bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:value-gray-400 dark:text-white" value="03" disabled required="" />
                                <input type="number" name="year" id="year" className="inline-block w-20 text-left ml-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:value-gray-400 dark:text-white" value="27" disabled required="" />
                            </div>
                            <div>
                                <label htmlFor="code" className="block mb-2 text-left text-sm  font-medium text-gray-900 dark:text-gray-300" >Security Code:</label>
