        ...
        <div className="flex flex-wrap justify-around">
            ...
            <p className="text-3xl font-bold text-gray-900 dark:text-slate-200">
              ...
              <p className='my-4 select-none'>
                ...
                <span className="font-semibold text-blue-500 border bg-slate-100 rounded-lg px-3 py-1 mr-2">Available {product.size}</span>

              </p>
              <button className="inline-flex items-center py-2 px-5 mb-3 text-lg font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-900">
